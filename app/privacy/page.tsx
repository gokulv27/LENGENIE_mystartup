      ...
      <div className="max-w-[780px] mx-auto">
        ...
        <div className="space-y-8 text-text-secondary text-[15px] leading-relaxed">
          {[
            ...
            { title: "4. Data Retention", body: "We retain your order data for 3 years for legal and accounting purposes. You may request deletion of personal data at any time by emailing support@lengenie.com." },
            ...
            { title: "6. Contact", body: "For privacy questions or data deletion requests, contact: privacy@lengenie.com" },
          ].map(s => (
            <div key={s.title}>
